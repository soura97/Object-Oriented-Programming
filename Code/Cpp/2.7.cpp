...
{
    strcpy(book_list, "Book.txt");
    strcpy(journal_list, "Journal.txt");
    strcpy(member_list, "Member.txt");
    strcpy(register_list, "Register.txt");
}
...
int main() {
	...
	while(true) {
		...
		switch (choice) {
		    ...
		    case 1:    std::cout << "1 Add member      2 Add book        3 Add journal     \n";
		    				std::cout << "\nChoice: ";
		    		std::cin>>choice;
		    		switch(choice) {
		    				case 1: 
                			...
                			lib.add_journal();
			                break;}break;
            case 2:		std::cout << "1 Issue book      2 Issue journal    \n";
            					std::cout << "\nChoice: ";
            			std::cin>>choice;
            			switch(choice) {
            				case 1:
